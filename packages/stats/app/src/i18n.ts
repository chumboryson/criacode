...
const en = {
  "app.title": "AI Model Usage Rankings | Cria Code Data",
  "app.description":
    "Explore Cria Code Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Cria Code Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Cria Code on GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Try Cria Code",
  ...
  "footer.homeAria": "Cria Code home",
  ...
  "home.topModelsDescription": "Usage of models across Cria Code Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Cria Code Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Cria Code Data",
  "lab.description":
    "Compare {{lab}} models used in Cria Code Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Cria Code usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Cria Code",
  ...
  "lab.shareOfUsage": "{{share}} of recent Cria Code usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Cria Code Data",
  "model.description":
    "View {{model}} Cria Code Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Cria Code Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Cria Code Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Cria Code Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Cria Code Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Cria Code Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Cria Code Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Cria Code Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Cria Code Go token volume.",
