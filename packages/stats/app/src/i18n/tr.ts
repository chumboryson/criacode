export const dict = {
  ...
  "header.tryCria Code": "Cria Code'u dene",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Cria Code kullanıcıları.",
  ...
  "model.description":
    "{{model}} için Cria Code kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Cria Code kullanımı görünür.",
  "model.unranked": "Geçen haftaki Cria Code kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Cria Code kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Cria Code kullanımı yok.",
  ...
  "model.overviewDescription": "Son Cria Code tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Cria Code kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Cria Code token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Cria Code kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Cria Code oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Cria Code model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Cria Code coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Cria Code token hacmine göre yakındaki modeller.",
