export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Cria Code Data",
  "app.description":
    "Cria Code Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Cria Code Data logosu",
  ...
  "header.githubAria": "GitHub'da Cria Code'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOpenCode": "Cria Code'u dene",
  ...
  "footer.homeAria": "Cria Code ana sayfası",
  ...
  "home.topModelsDescription": "Cria Code Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Cria Code Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Cria Code Data",
  "lab.description":
    "Cria Code Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Cria Code kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Cria Code'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Cria Code kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Cria Code token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Cria Code Data",
  "model.description":
    "{{model}} için Cria Code Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Cria Code Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Cria Code Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Cria Code Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Cria Code Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Cria Code Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Cria Code Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Cria Code Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Cria Code Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Cria Code Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Cria Code Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Cria Code Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Cria Code Go token hacmine göre yakındaki modeller.",
