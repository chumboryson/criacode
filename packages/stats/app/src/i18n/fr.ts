export const dict = {
  ...
  "app.description":
    "Explorez l'utilisation d'Cria Code par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  ...
  "header.tryCria Code": "Essayer Cria Code",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans Cria Code.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'Cria Code par modèle.",
  ...
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans Cria Code, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  ...
  "model.description":
    "Consultez les données d'utilisation Cria Code de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation Cria Code apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation Cria Code de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation Cria Code de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation Cria Code dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens Cria Code récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation Cria Code.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens Cria Code sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'Cria Code sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions Cria Code.",
  ...
  "model.geoDescription": "Tokens du modèle Cria Code utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique Cria Code ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens Cria Code.",
