export const dict = {
  ...
  "app.description":
    "Esplora l'utilizzo di Cria Code nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  ...
  "header.tryCria Code": "Prova Cria Code",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Cria Code.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Cria Code per modello.",
  ...
  "lab.description":
    "Confronta i modelli {{lab}} usati in Cria Code, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  ...
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Cria Code, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Cria Code appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Cria Code della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Cria Code della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Cria Code nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Cria Code, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Cria Code.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Cria Code nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Cria Code nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Cria Code.",
  ...
  "model.geoDescription": "Token del modello Cria Code usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Cria Code corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Cria Code.",
