export const dict = {
  ...
  "app.description":
    "Explore o uso do Cria Code em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  ...
  "header.tryCria Code": "Experimente o Cria Code",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Cria Code.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Cria Code por modelo.",
  ...
  "lab.description":
    "Compare modelos da {{lab}} usados no Cria Code, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  ...
  "model.description":
    "Veja dados de uso de {{model}} no Cria Code, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Cria Code aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Cria Code da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Cria Code da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Cria Code na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Cria Code, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Cria Code.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Cria Code na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Cria Code na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Cria Code.",
  ...
  "model.geoDescription": "Tokens do modelo Cria Code usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Cria Code correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Cria Code.",
