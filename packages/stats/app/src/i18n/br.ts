export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Cria Code Data",
  "app.description":
    "Explore o uso do Cria Code Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Cria Code Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Cria Code no GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Experimente o Cria Code",
  ...
  "footer.homeAria": "Início do Cria Code",
  ...
  "modal.title": "Newsletter do Cria Code",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Cria Code Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Cria Code Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Cria Code Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Cria Code Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Cria Code.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Cria Code",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Cria Code",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Cria Code nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Cria Code Data",
  "model.description":
    "Veja dados de uso de {{model}} no Cria Code Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Cria Code Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Cria Code Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Cria Code Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Cria Code Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Cria Code Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Cria Code Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Cria Code Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Cria Code Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Cria Code Go.",
  ...
  "model.geoDescription": "Tokens do modelo Cria Code Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Cria Code Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Cria Code Go.",
