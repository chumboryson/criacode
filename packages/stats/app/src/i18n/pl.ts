export const dict = {
  "app.title": "Rankingi użycia modeli AI | Cria Code Data",
  "app.description":
    "Przeglądaj użycie Cria Code Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Cria Code Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Cria Code na GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Wypróbuj Cria Code",
  ...
  "footer.homeAria": "Strona główna Cria Code",
  ...
  "home.topModelsDescription": "Użycie modeli w Cria Code Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Cria Code Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Cria Code Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Cria Code Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Cria Code.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Cria Code",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Cria Code",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Cria Code z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Cria Code Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Cria Code Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Cria Code Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Cria Code Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Cria Code Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Cria Code Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Cria Code Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Cria Code Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Cria Code Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Cria Code Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Cria Code Go.",
  ...
  "model.geoDescription": "Tokeny modelu Cria Code Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Cria Code Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Cria Code Go.",
