export const dict = {
  ...
  "app.description":
    "Przeglądaj użycie Cria Code w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  ...
  "header.tryCria Code": "Wypróbuj Cria Code",
  ...
  "home.topModelsDescription": "Użycie modeli w Cria Code.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Cria Code według modelu.",
  ...
  "lab.description":
    "Porównaj modele {{lab}} używane w Cria Code, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  ...
  "model.description":
    "Zobacz dane użycia {{model}} w Cria Code, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Cria Code pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Cria Code z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Cria Code z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Cria Code w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Cria Code, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Cria Code.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Cria Code w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Cria Code w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Cria Code.",
  ...
  "model.geoDescription": "Tokeny modelu Cria Code użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Cria Code nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Cria Code.",
