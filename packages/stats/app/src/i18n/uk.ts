export const dict = {
  ...
  "app.description":
    "Досліджуйте використання Cria Code серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  ...
  "header.tryCria Code": "Спробувати Cria Code",
  ...
  "home.topModelsDescription": "Використання моделей в Cria Code.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі Cria Code за моделлю.",
  ...
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в Cria Code, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  ...
  "model.description":
    "Перегляньте дані використання {{model}} в Cria Code, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання Cria Code з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні Cria Code за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні Cria Code за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання Cria Code в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени Cria Code, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання Cria Code.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів Cria Code за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі Cria Code за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу Cria Code.",
  ...
  "model.geoDescription": "Токени моделі Cria Code, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки Cria Code не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів Cria Code.",
