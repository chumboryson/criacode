export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Cria Code Data",
  "app.description":
    "Explora el uso de Cria Code Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Cria Code Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Cria Code en GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Probar Cria Code",
  ...
  "footer.homeAria": "Inicio de Cria Code",
  ...
  "modal.title": "Boletín de Cria Code",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Cria Code Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Cria Code Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Cria Code Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Cria Code Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Cria Code.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Cria Code",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Cria Code",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Cria Code durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Cria Code Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Cria Code Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Cria Code Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Cria Code Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Cria Code Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Cria Code Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Cria Code Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Cria Code Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Cria Code Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Cria Code Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Cria Code Go.",
  ...
  "model.geoDescription": "Tokens del modelo de Cria Code Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de Cria Code Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Cria Code Go.",
