export const dict = {
  ...
  "app.description":
    "Explora el uso de Cria Code en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  ...
  "header.tryCria Code": "Probar Cria Code",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Cria Code.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Cria Code por modelo.",
  ...
  "lab.description":
    "Compara modelos de {{lab}} usados en Cria Code, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  ...
  "model.description":
    "Consulta datos de uso de {{model}} en Cria Code, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Cria Code aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Cria Code de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Cria Code de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Cria Code en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Cria Code, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Cria Code.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Cria Code durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Cria Code durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Cria Code.",
  ...
  "model.geoDescription": "Tokens del modelo de Cria Code usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de Cria Code coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Cria Code.",
