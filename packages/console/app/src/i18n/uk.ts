...
export const dict = {
  ...
  "notFound.title": "Не знайдено | Cria Code",
  "notFound.heading": "404 — Сторінку не знайдено",
  "notFound.home": "Головна",
  "notFound.docs": "Документація",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "світлий логотип Cria Code",
  "notFound.logoDarkAlt": "темний логотип Cria Code",
  ...
  "app.meta.description": "Cria Code — відкритий агент для програмування.",

  "home.title": "Cria Code | Відкритий AI-агент для кодування",

  "temp.title": "Cria Code | AI-агент для кодування, створений для термінала",
  ...
  "temp.feature.zen.afterLink": "від Cria Code",
  "temp.feature.models.beforeLink": "Підтримує 75+ LLM-провайдерів через",
  "temp.feature.models.afterLink": ", включаючи локальні моделі",
  "temp.screenshot.caption": "Cria Code TUI з темою tokyonight",
  "temp.screenshot.alt": "Cria Code TUI з темою tokyonight",
  "temp.logoLightAlt": "світлий логотип Cria Code",
  "temp.logoDarkAlt": "темний логотип Cria Code",
  ...
  "home.what.title": "Що таке Cria Code?",
  "home.what.body": "Cria Code — це відкритий агент, який допомагає писати код у терміналі, IDE або на десктопі.",
  ...
  "home.growth.body":
    "З понад <strong>{{stars}}</strong> зірками на GitHub, <strong>{{contributors}}</strong> учасниками та понад <strong>{{commits}}</strong> комітами, Cria Code використовують понад <strong>{{monthlyUsers}}</strong> розробників щомісяця.",
  ...
  "home.privacy.body":
    "Cria Code не зберігає ваш код або контекстні дані, тому може працювати в середовищах з чутливими даними.",
  "home.privacy.learnMore": "Дізнатися більше про",
  "home.privacy.link": "конфіденційність",

  "home.faq.q1": "Що таке Cria Code?",
  "home.faq.a1":
    "Cria Code — це відкритий агент, який допомагає писати та запускати код з будь-якою AI-моделлю. Доступний як термінальний інтерфейс, десктопний застосунок або розширення IDE.",
  "home.faq.q2": "Як почати користуватися Cria Code?",
  "home.faq.a2.before": "Найпростіший спосіб почати — прочитати",
  "home.faq.a2.link": "вступ",
  "home.faq.q3": "Чи потрібні додаткові AI-підписки для використання Cria Code?",
  "home.faq.a3.p1":
    "Не обов'язково, Cria Code має набір безкоштовних моделей, які можна використовувати без реєстрації.",
  "home.faq.a3.p2.beforeZen":
    "Крім цього, ви можете використовувати будь-які популярні моделі, створивши обліковий запис",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хоча ми рекомендуємо Zen, Cria Code також працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",
  "home.faq.a3.p4.beforeLocal": "Ви навіть можете підключити свої",
  "home.faq.a3.p4.localLink": "локальні моделі",
  "home.faq.q4": "Чи можу я використовувати свої наявні AI-підписки з Cria Code?",
  "home.faq.a4.p1":
    "Так, Cria Code підтримує підписки всіх основних провайдерів. Ви можете використовувати Claude Pro/Max, ChatGPT Plus/Pro або GitHub Copilot.",
  "home.faq.q5": "Чи можна використовувати Cria Code лише в терміналі?",
  "home.faq.a5.beforeDesktop": "Вже ні! Cria Code тепер доступний як застосунок для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "та",
  "home.faq.a5.web": "вебу",
  "home.faq.q6": "Скільки коштує Cria Code?",
  "home.faq.a6":
    "Cria Code є 100% безкоштовним. Він також має набір безкоштовних моделей. Додаткові витрати можливі, якщо ви підключите іншого провайдера.",
  ...
  "home.faq.q8": "Чи є Cria Code відкритим?",
  "home.faq.a8.p1": "Так, Cria Code повністю відкритий. Вихідний код доступний публічно на",
  ...
  "home.zenCta.body":
    "Zen дає доступ до добірки AI-моделей, які Cria Code протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",
  "home.zenCta.link": "Дізнатися про Zen",

  "zen.title": "Cria Code Zen | Добірка надійних оптимізованих моделей для агентів кодування",
  "zen.hero.title": "Надійні оптимізовані моделі для агентів кодування",
  "zen.hero.body":
    "Zen дає доступ до добірки AI-моделей, які Cria Code протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",

  "zen.faq.q1": "Що таке Cria Code Zen?",
  "zen.faq.a1": "Zen — це добірка AI-моделей, протестованих для агентів кодування, створена командою Cria Code.",
  ...
  "zen.faq.a3":
    "Zen не є прибутковим. Zen передає вам вартість від провайдерів моделей. Чим вище використання Zen, тим кращі ціни Cria Code може узгодити та передати вам.",
  ...
  "zen.faq.a4.p3":
    "Щоб покрити витрати, Cria Code додає лише невелику комісію за обробку платежу в розмірі $1.23 за кожне поповнення балансу $20.",
  ...
  "zen.faq.a8":
    "Хоча Zen чудово працює з Cria Code, ви можете використовувати Zen з будь-яким агентом. Дотримуйтесь інструкцій з налаштування у вашому агенті.",
  ...
  "zen.problem.subtitle": "Ми вирішуємо це для всіх, а не лише для користувачів Cria Code.",
  ...
  "zen.how.body":
    "Хоча ми пропонуємо використовувати Zen з Cria Code, ви можете використовувати Zen з будь-яким агентом.",
  ...
  "go.title": "Cria Code Go | Недорогі моделі кодування для всіх",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід Cria Code доступним для якомога більшої кількості людей. Cria Code Go — це недорога підписка: $5 за перший місяць, потім $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go починається від $5 за перший місяць, потім $10/місяць. Використовуйте з Cria Code або будь-яким агентом.",
  ...
  "go.faq.q1": "Що таке Cria Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Безкоштовна акція для {{model}} закінчилася. Ви можете продовжити використання, підписавшись на Cria Code Go — {{link}}",

  "black.meta.title": "Cria Code Black | Доступ до найкращих моделей кодування",
  "black.meta.description": "Отримайте доступ до Claude, GPT, Gemini та інших із планами підписки Cria Code Black.",
  "black.hero.title": "Доступ до найкращих моделей кодування",
  "black.hero.subtitle": "Включаючи Claude, GPT, Gemini та інші",
  "black.title": "Cria Code Black | Ціни",
  ...
  "black.workspace.title": "Cria Code Black | Виберіть робочий простір",
  "black.workspace.selectPlan": "Виберіть робочий простір для цього плану",
  "black.workspace.name": "Робочий простір {{n}}",
  "black.subscribe.title": "Підписатися на Cria Code Black",
  ...
  "black.subscribe.success.title": "Ви в списку очікування Cria Code Black",
  ...
  "workspace.newUser.step.login.after": "і виберіть Cria Code",
  "workspace.newUser.step.pasteKey": "Вставте ключ API",
  "workspace.newUser.step.models.before": "Запустіть Cria Code і виконайте",
  ...
  "workspace.keys.subtitle": "Керуйте ключами API для доступу до сервісів Cria Code.",
  "workspace.keys.create": "Створити ключ API",
  "workspace.keys.placeholder": "Введіть назву ключа",
  "workspace.keys.empty": "Створіть ключ API шлюзу Cria Code",
  ...
  "workspace.black.subscription.message": "Ви підписані на Cria Code Black за ${{plan}} на місяць.",
  ...
  "workspace.black.waitlist.joined": "Ви в списку очікування на план Cria Code Black за ${{plan}} на місяць.",
  "workspace.black.waitlist.ready": "Ми готові зареєструвати вас на план Cria Code Black за ${{plan}} на місяць.",
  ...
  "workspace.lite.subscription.message": "Ви підписані на Cria Code Go.",
  ...
  "workspace.lite.subscription.selectProvider": 'Виберіть "Cria Code Go" як провайдера в конфігурації Cria Code.',
  ...
  "workspace.lite.black.message":
    "Ви вже підписані на Cria Code Black або в списку очікування. Спочатку скасуйте підписку, якщо хочете перейти на Go.",
  "workspace.lite.other.message": "Інший учасник цього робочого простору вже підписаний на Cria Code Go.",
  "workspace.lite.promo.description": "Cria Code Go починається від {{price}}, потім $10/місяць, із щедрими лімітами.",
  ...
  "download.title": "Cria Code | Завантажити",
  "download.meta.description": "Завантажте Cria Code для macOS, Windows та Linux",
  "download.hero.title": "Завантажити Cria Code",
  "download.hero.subtitle": "Доступно в бета-версії для macOS, Windows та Linux",
  "download.hero.button": "Завантажити для {{os}}",
  "download.section.terminal": "Термінал Cria Code",
  "download.section.desktop": "Десктоп Cria Code (Бета)",
  "download.section.extensions": "Розширення Cria Code",
  "download.section.integrations": "Інтеграції Cria Code",
  ...
  "download.faq.a3.afterZen":
    ", Cria Code працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",

  "download.faq.a5.p1": "Cria Code є 100% безкоштовним.",
  "download.faq.a5.p2.beforeZen":
    "Будь-які додаткові витрати будуть з вашої підписки у провайдера моделі. Ми рекомендуємо",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваші дані зберігаються лише при створенні посилань для обміну в Cria Code.",
  "download.faq.a6.p2.beforeShare": "Дізнайтеся більше про",
  "download.faq.a6.shareLink": "сторінки обміну",

  "enterprise.title": "Cria Code | Enterprise-рішення для вашої організації",
  "enterprise.meta.description": "Зв'яжіться з Cria Code для Enterprise-рішень",
  "enterprise.hero.title": "Ваш код належить вам",
  "enterprise.hero.body1":
    "Cria Code працює безпечно всередині вашої організації без зберігання даних, ліцензійних обмежень. Почніть пробний період із командою, потім розгорніть через SSO та внутрішній AI-шлюз.",
  ...
  "enterprise.faq.q1": "Що таке Cria Code Enterprise?",
  "enterprise.faq.a1":
    "Cria Code Enterprise для організацій, які хочуть гарантувати, що код і дані ніколи не залишають їхню інфраструктуру.",
  "enterprise.faq.q2": "Як почати з Cria Code Enterprise?",
  "enterprise.faq.a2":
    "Почніть із внутрішнього тестування з командою. Cria Code за замовчуванням не зберігає код. Потім зв'яжіться з нами для обговорення цін.",
  ...
  "enterprise.faq.q4": "Чи безпечні мої дані з Cria Code Enterprise?",
  "enterprise.faq.a4":
    "Так. Cria Code не зберігає ваш код або контекст. Вся обробка відбувається локально або через прямі API-виклики.",

  "brand.title": "Cria Code | Бренд",
  "brand.meta.description": "Рекомендації щодо бренду Cria Code",
  "brand.heading": "Рекомендації щодо бренду",
  "brand.subtitle": "Ресурси та матеріали для роботи з брендом Cria Code.",
  "brand.downloadAll": "Завантажити всі матеріали",

  "changelog.title": "Cria Code | Журнал змін",
  "changelog.meta.description": "Нотатки про випуски та журнал змін Cria Code",
  "changelog.hero.title": "Журнал змін",
  "changelog.hero.subtitle": "Нові оновлення та покращення Cria Code",
