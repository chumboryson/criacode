...
export const dict = {
  ...
  "notFound.title": "No encontrado | Cria Code",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Cria Code logo claro",
  "notFound.logoDarkAlt": "Cria Code logo oscuro",
  ...
  "app.meta.description": "Cria Code - El agente de codificación de código abierto.",

  "home.title": "Cria Code | El agente de codificación IA de código abierto",

  "temp.title": "Cria Code | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "Cria Code zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por Cria Code",
  ...
  "temp.screenshot.caption": "Cria Code TUI con el tema tokyonight",
  "temp.screenshot.alt": "Cria Code TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de Cria Code claro",
  "temp.logoDarkAlt": "logo de Cria Code oscuro",
  ...
  "home.what.title": "¿Qué es Cria Code?",
  "home.what.body":
    "Cria Code es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, Cria Code es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "Cria Code no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es Cria Code?",
  "home.faq.a1":
    "Cria Code es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso Cria Code?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar Cria Code?",
  "home.faq.a3.p1":
    "No necesariamente, Cria Code viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, Cria Code también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con Cria Code?",
  "home.faq.a4.p1":
    "Sí, Cria Code soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar Cria Code en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! Cria Code ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta Cria Code?",
  "home.faq.a6":
    "Cria Code es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es Cria Code de código abierto?",
  "home.faq.a8.p1": "Sí, Cria Code es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que Cria Code ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "Cria Code Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que Cria Code ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es Cria Code Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de Cria Code.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá Cria Code negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, Cria Code añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con Cria Code, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de Cria Code.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con Cria Code, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "Cria Code Go | Modelos de programación de bajo coste para todos",
  "go.meta.description":
  ...
  "go.testimonials.handle": "@Cria Code",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de Cria Code a tantas personas como sea posible. Cria Code Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con Cria Code o cualquier agente.",
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a Cria Code Go - {{link}}",

  "black.meta.title": "Cria Code Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de Cria Code Black.",
  ...
  "black.title": "Cria Code Black | Precios",
  ...
  "black.workspace.title": "Cria Code Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a Cria Code Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de Cria Code Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "Cria Code Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con Cria Code cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona Cria Code",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia Cria Code y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de Cria Code.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de Cria Code Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a Cria Code Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan Cria Code Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan Cria Code Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a Cria Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "Cria Code Go" como proveedor en tu configuración de Cria Code para usar los modelos Go.',
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a Cria Code Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a Cria Code Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "Cria Code Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "Cria Code | Descargar",
  "download.meta.description": "Descarga Cria Code para macOS, Windows y Linux",
  "download.hero.title": "Descargar Cria Code",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "Cria Code Terminal",
  "download.section.desktop": "Cria Code Desktop (Beta)",
  "download.section.extensions": "Extensiones Cria Code",
  "download.section.integrations": "Integraciones Cria Code",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar Cria Code a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", Cria Code funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Cria Code es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque Cria Code funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en Cria Code.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "Cria Code | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a Cria Code para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "Cria Code opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es Cria Code Enterprise?",
  "enterprise.faq.a1":
    "Cria Code Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con Cria Code Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. Cria Code por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con Cria Code Enterprise?",
  "enterprise.faq.a4":
    "Sí. Cria Code no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "Cria Code | Marca",
  "brand.meta.description": "Guías de marca de Cria Code",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca Cria Code.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "Cria Code | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de Cria Code",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para Cria Code",
