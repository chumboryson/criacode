...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | Cria Code",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo Cria Code",
  "notFound.logoDarkAlt": "ciemne logo Cria Code",
  ...
  "app.meta.description": "Cria Code - Otwartoźródłowy agent programistyczny.",

  "home.title": "Cria Code | Open source'owy agent AI do kodowania",

  "temp.title": "Cria Code | Agent AI do kodowania zbudowany dla terminala",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez Cria Code",
  "temp.feature.models.beforeLink": "Obsługuje 75+ dostawców LLM przez",
  "temp.feature.models.afterLink": ", w tym modele lokalne",
  "temp.screenshot.caption": "Cria Code TUI z motywem tokyonight",
  "temp.screenshot.alt": "Cria Code TUI z motywem tokyonight",
  "temp.logoLightAlt": "jasne logo Cria Code",
  "temp.logoDarkAlt": "ciemne logo Cria Code",
  ...
  "home.what.title": "Czym jest Cria Code?",
  "home.what.body":
    "Cria Code to open source'owy agent, który pomaga pisać kod w terminalu, IDE lub aplikacji desktopowej.",
  ...
  "home.growth.body":
    "Z ponad <strong>{{stars}}</strong> gwiazdkami na GitHubie, <strong>{{contributors}}</strong> współtwórcami i ponad <strong>{{commits}}</strong> commitami, Cria Code jest używany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperów każdego miesiąca.",
  ...
  "home.privacy.body":
    "Cria Code nie przechowuje Twojego kodu ani danych kontekstowych, dzięki czemu może działać w środowiskach wrażliwych na prywatność.",
  "home.privacy.learnMore": "Dowiedz się więcej o",
  "home.privacy.link": "prywatności",

  "home.faq.q1": "Czym jest Cria Code?",
  "home.faq.a1":
    "Cria Code to open source'owy agent, który pomaga pisać i uruchamiać kod z dowolnym modelem AI. Jest dostępny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystać z Cria Code?",
  "home.faq.a2.before": "Najłatwiej zacząć od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuję dodatkowych subskrypcji AI, aby używać Cria Code?",
  "home.faq.a3.p1":
    "Niekoniecznie. Cria Code posiada zestaw darmowych modeli, z których możesz korzystać bez zakładania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym możesz używać dowolnych popularnych modeli do kodowania, tworząc konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Chociaż zachęcamy do korzystania z Zen, Cria Code działa również ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",
  "home.faq.a3.p4.beforeLocal": "Możesz nawet podłączyć swoje",
  "home.faq.a3.p4.localLink": "lokalne modele",
  "home.faq.q4": "Czy mogę używać moich istniejących subskrypcji AI z Cria Code?",
  "home.faq.a4.p1":
    "Tak, Cria Code obsługuje plany subskrypcyjne od wszystkich głównych dostawców. Możesz używać swoich subskrypcji Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy mogę używać Cria Code tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Już nie! Cria Code jest teraz dostępny jako aplikacja na",
  "home.faq.a5.desktop": "pulpit (desktop)",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje Cria Code?",
  "home.faq.a6":
    "Cria Code jest w 100% darmowy. Zawiera również zestaw darmowych modeli. Mogą pojawić się dodatkowe koszty, jeśli podłączysz innego dostawcę.",
  ...
  "home.faq.q8": "Czy Cria Code jest open source?",
  "home.faq.a8.p1": "Tak, Cria Code jest w pełni open source. Kod źródłowy jest publicznie dostępny na",
  ...
  "home.zenCta.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które Cria Code przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość u różnych dostawców, używaj sprawdzonych modeli, które działają.",
  "home.zenCta.link": "Dowiedz się więcej o Zen",

  "zen.title": "Cria Code Zen | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentów kodujących",
  "zen.hero.title": "Niezawodne, zoptymalizowane modele dla agentów kodujących",
  "zen.hero.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które Cria Code przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość, używaj sprawdzonych modeli, które działają.",

  "zen.faq.q1": "Czym jest Cria Code Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i sprawdzonych pod kątem agentów kodujących, stworzony przez zespół stojący za Cria Code.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty od dostawców modeli bezpośrednio do Ciebie. Im większe użycie Zen, tym lepsze stawki Cria Code może wynegocjować i przekazać Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryć koszty, Cria Code dolicza jedynie niewielką opłatę za przetwarzanie płatności w wysokości $1.23 przy każdym doładowaniu salda o $20.",
  ...
  "zen.faq.a8":
    "Chociaż Zen świetnie działa z Cria Code, możesz używać Zen z dowolnym agentem. Postępuj zgodnie z instrukcjami konfiguracji w swoim preferowanym agencie.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników Cria Code.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z Cria Code, możesz używać Zen z dowolnym agentem.",
  ...
  "go.title": "Cria Code Go | Niskokosztowe modele do kodowania dla każdego",
  "go.meta.description":
  ...
  "go.problem.body":
    "Skupiamy się na udostępnieniu doświadczenia Cria Code jak największej liczbie osób. Cria Code Go to tania subskrypcja: $5 za pierwszy miesiąc, potem $10/miesiąc. Zapewnia hojne limity i niezawodny dostęp do najbardziej wydajnych modeli open source.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go zaczyna się od $5 za pierwszy miesiąc, potem $10/miesiąc. Możesz go używać z Cria Code lub dowolnym agentem.",
  ...
  "go.faq.q1": "Czym jest Cria Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Bezpłatna promocja {{model}} dobiegła końca. Możesz dalej korzystać z modelu, subskrybując Cria Code Go - {{link}}",

  "black.meta.title": "Cria Code Black | Dostęp do najlepszych na świecie modeli kodujących",
  "black.meta.description": "Uzyskaj dostęp do Claude, GPT, Gemini i innych dzięki planom subskrypcji Cria Code Black.",
  "black.hero.title": "Dostęp do najlepszych na świecie modeli kodujących",
  "black.hero.subtitle": "W tym Claude, GPT, Gemini i inne",
  "black.title": "Cria Code Black | Cennik",
  ...
  "black.workspace.title": "Cria Code Black | Wybierz obszar roboczy",
  "black.workspace.selectPlan": "Wybierz obszar roboczy dla tego planu",
  "black.workspace.name": "Obszar roboczy {{n}}",
  "black.subscribe.title": "Subskrybuj Cria Code Black",
  ...
  "black.subscribe.success.title": "Jesteś na liście oczekujących Cria Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z Cria Code, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz Cria Code",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom Cria Code i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług Cria Code.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy Cria Code",
  ...
  "workspace.black.subscription.message": "Subskrybujesz Cria Code Black za ${{plan}} miesięcznie.",
  ...
  "workspace.black.waitlist.joined": "Jesteś na liście oczekujących na plan Cria Code Black za ${{plan}} miesięcznie.",
  "workspace.black.waitlist.ready": "Jesteśmy gotowi zapisać Cię do planu Cria Code Black za ${{plan}} miesięcznie.",
  ...
  "workspace.lite.subscription.message": "Subskrybujesz Cria Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "Cria Code Go" jako dostawcę w konfiguracji Cria Code, aby używać modeli Go.',
  ...
  "workspace.lite.black.message":
    "Obecnie subskrybujesz Cria Code Black lub jesteś na liście oczekujących. Jeśli chcesz przejść na Go, najpierw anuluj subskrypcję.",
  "workspace.lite.other.message":
    "Inny członek tego obszaru roboczego już subskrybuje Cria Code Go. Tylko jeden członek na obszar roboczy może subskrybować.",
  "workspace.lite.promo.description":
    "Cria Code Go zaczyna się od {{price}}, potem $10/miesiąc, i zapewnia niezawodny dostęp do popularnych otwartych modeli kodowania z hojnymi limitami użycia.",
  ...
  "download.title": "Cria Code | Pobierz",
  "download.meta.description": "Pobierz Cria Code na macOS, Windows i Linux",
  "download.hero.title": "Pobierz Cria Code",
  "download.hero.subtitle": "Dostępne w wersji Beta na macOS, Windows i Linux",
  "download.hero.button": "Pobierz na {{os}}",
  "download.section.terminal": "Terminal Cria Code",
  "download.section.desktop": "Pulpit Cria Code (Beta)",
  "download.section.extensions": "Rozszerzenia Cria Code",
  "download.section.integrations": "Integracje Cria Code",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Będziesz potrzebować subskrypcji AI, jeśli chcesz połączyć Cria Code z płatnym dostawcą, chociaż możesz pracować z",
  ...
  "download.faq.a3.afterZen":
    ", Cria Code współpracuje ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",

  "download.faq.a5.p1": "Cria Code jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty będą pochodzić z Twojej subskrypcji u dostawcy modelu. Chociaż Cria Code współpracuje z dowolnym dostawcą modeli, zalecamy korzystanie z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje są przechowywane tylko wtedy, gdy tworzysz linki do udostępniania w Cria Code.",
  "download.faq.a6.p2.beforeShare": "Dowiedz się więcej o",
  "download.faq.a6.shareLink": "stronach udostępniania",

  "enterprise.title": "Cria Code | Rozwiązania Enterprise dla Twojej organizacji",
  "enterprise.meta.description": "Skontaktuj się z Cria Code w sprawie rozwiązań dla przedsiębiorstw",
  "enterprise.hero.title": "Twój kod jest Twój",
  "enterprise.hero.body1":
    "Cria Code działa bezpiecznie wewnątrz Twojej organizacji bez przechowywania danych czy kontekstu, oraz bez ograniczeń licencyjnych czy roszczeń własnościowych. Rozpocznij okres próbny ze swoim zespołem, a następnie wdróż go w całej organizacji, integrując z SSO i wewnętrzną bramą AI.",
  ...
  "enterprise.faq.q1": "Czym jest Cria Code Enterprise?",
  "enterprise.faq.a1":
    "Cria Code Enterprise jest dla organizacji, które chcą mieć pewność, że ich kod i dane nigdy nie opuszczą ich infrastruktury. Można to osiągnąć dzięki scentralizowanej konfiguracji, która integruje się z Twoim SSO i wewnętrzną bramą AI.",
  "enterprise.faq.q2": "Jak zacząć z Cria Code Enterprise?",
  "enterprise.faq.a2":
    "Po prostu rozpocznij wewnętrzny okres próbny ze swoim zespołem. Cria Code domyślnie nie przechowuje Twojego kodu ani danych kontekstowych, co ułatwia start. Następnie skontaktuj się z nami, aby omówić opcje cenowe i wdrożeniowe.",
  ...
  "enterprise.faq.q4": "Czy moje dane są bezpieczne z Cria Code Enterprise?",
  "enterprise.faq.a4":
    "Tak. Cria Code nie przechowuje Twojego kodu ani danych kontekstowych. Całe przetwarzanie odbywa się lokalnie lub poprzez bezpośrednie wywołania API do Twojego dostawcy AI. Dzięki centralnej konfiguracji i integracji SSO, Twoje dane pozostają bezpieczne w infrastrukturze Twojej organizacji.",

  "brand.title": "Cria Code | Marka",
  "brand.meta.description": "Wytyczne marki Cria Code",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i aktywa, które pomogą Ci pracować z marką Cria Code.",
  "brand.downloadAll": "Pobierz wszystkie zasoby",

  "changelog.title": "Cria Code | Dziennik zmian",
  "changelog.meta.description": "Notatki o wydaniu i dziennik zmian Cria Code",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia Cria Code",
