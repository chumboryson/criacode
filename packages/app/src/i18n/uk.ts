export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.Cria Code.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.Cria CodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Cria Code.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в Cria Code.json",
  ...
  "dialog.server.description": "Перемкніть сервер Cria Code, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingCria Code": "Перевірка Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Перевірка Cria Code у {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Оновлення Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Оновлення Cria Code у {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Оновіть Cria Code у {{distro}}.",
  "wsl.onboarding.updateCria Code": "Оновити Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code готовий до роботи у {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code готовий до роботи.",
  "wsl.onboarding.installCria CodeIn": "Встановіть Cria Code у {{distro}}.",
  "wsl.onboarding.installCria Code": "Встановити Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Cria Code потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Cria Code не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Cria Code.",
  ...
  "toast.update.description": "Нова версія Cria Code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Cria Code",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (Cria Code.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Cria Code ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Cria Code всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Cria Code",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Cria Code на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Cria Code використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Cria Code.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Cria Code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Cria Code.",
