...
export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.Cria Code.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.Cria CodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Cria Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Cria Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Cria Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Cria Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler Cria Code.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Cria Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingCria Code": "Cria Code kontrol ediliyor...",
  "wsl.onboarding.checkingCria CodeIn": "{{distro}} içinde Cria Code kontrol ediliyor...",
  "wsl.onboarding.updatingCria Code": "Cria Code güncelleniyor...",
  "wsl.onboarding.updatingCria CodeIn": "{{distro}} içinde Cria Code güncelleniyor...",
  "wsl.onboarding.updateCria CodeIn": "{{distro}} içindeki Cria Code'u güncelleyin.",
  "wsl.onboarding.updateCria Code": "Cria Code'u güncelle",
  "wsl.onboarding.Cria CodeReadyIn": "{{distro}} içinde Cria Code hazır.",
  "wsl.onboarding.Cria CodeReady": "Cria Code hazır.",
  "wsl.onboarding.installCria CodeIn": "Cria Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installCria Code": "Cria Code'u kur",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cria Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Cria Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Cria Code'u tekrar açın.",
  ...
  "toast.update.description": "Cria Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Cria Code ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (Cria Code.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Cria Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Cria Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "Cria Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Cria Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Cria Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Cria Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Cria Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Cria Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Cria Code'un en son sürümünü kullanıyorsunuz.",
