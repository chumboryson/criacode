export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.Cria Code.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.Cria CodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Cria Code-u.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Posjeti ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Cria Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Cria Code-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u Cria Code.json",
  ...
  "dialog.server.description": "Promijeni na koji se Cria Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingCria Code": "Provjera Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Provjera Cria Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Ažuriranje Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Ažuriranje Cria Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Ažuriraj Cria Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateCria Code": "Ažuriraj Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code je spreman.",
  "wsl.onboarding.installCria CodeIn": "Instaliraj Cria Code u distribuciji {{distro}}.",
  "wsl.onboarding.installCria Code": "Instaliraj Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Cria Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Cria Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Cria Code.",
  ...
  "toast.update.description": "Nova verzija Cria Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Cria Code timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (Cria Code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Cria Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Cria Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Cria Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Cria Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Cria Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Cria Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Cria Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Cria Code-a.",
