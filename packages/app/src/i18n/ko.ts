export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Cria Code 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Cria Code 확인 중...",
  "wsl.onboarding.updatingOpencode": "Cria Code 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Cria Code 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Cria Code를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Cria Code 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Cria Code를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Cria Code가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Cria Code를 설치하세요.",
  "wsl.onboarding.installOpencode": "Cria Code 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cria Code가 설치되지 않음",
