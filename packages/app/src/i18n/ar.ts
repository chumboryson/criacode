export const dict = {
  ...
  "dialog.provider.Cria Code.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.Cria Code.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.Cria CodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Cria Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "يمنحك Cria Code Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Cria Code.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في Cria Code.json",
  ...
  "dialog.server.description": "تبديل خادم Cria Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingCria Code": "جارٍ التحقق من Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "جارٍ التحقق من Cria Code في {{distro}}...",
  "wsl.onboarding.updatingCria Code": "جارٍ تحديث Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "جارٍ تحديث Cria Code في {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "حدّث Cria Code في {{distro}}.",
  "wsl.onboarding.updateCria Code": "تحديث Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code جاهز في {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code جاهز.",
  "wsl.onboarding.installCria CodeIn": "ثبّت Cria Code في {{distro}}.",
  "wsl.onboarding.installCria Code": "تثبيت Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Cria Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Cria Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Cria Code.",
  ...
  "toast.update.description": "نسخة جديدة من Cria Code ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Cria Code",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (Cria Code.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Cria Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Cria Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Cria Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Cria Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Cria Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Cria Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Cria Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Cria Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Cria Code.",
