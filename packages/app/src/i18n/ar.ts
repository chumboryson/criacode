export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Cria Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Cria Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Cria Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Cria Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Cria Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Cria Code",
  "wsl.onboarding.opencodeReadyIn": "Cria Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cria Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Cria Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Cria Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cria Code غير مثبت",
