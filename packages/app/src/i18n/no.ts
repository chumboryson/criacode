...
export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.Cria Code.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.Cria CodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Besøk ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Cria Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i Cria Code.json",
  ...
  "dialog.server.description": "Bytt hvilken Cria Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Cria Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Cria Code-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (Cria Code.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Cria Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Cria Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Cria Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Cria Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Cria Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Cria Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Cria Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Cria Code.",
  ...
  "wsl.onboarding.checkingCria Code": "Sjekker Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Sjekker Cria Code i {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Oppdaterer Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Oppdaterer Cria Code i {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Oppdater Cria Code i {{distro}}.",
  "wsl.onboarding.updateCria Code": "Oppdater Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code er klar i {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code er klar.",
  "wsl.onboarding.installCria CodeIn": "Installer Cria Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Cria Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Cria Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Cria Code på nytt.",
