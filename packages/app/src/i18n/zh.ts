...
export const dict = {
  ...
  "dialog.provider.Cria Code.note": "使用 Cria Code Zen 或 API 密钥连接",
  "dialog.provider.Cria Code.tagline": "可靠的优化模型",
  "dialog.provider.Cria CodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Cria Code 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Cria Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.Cria CodeZen.line1": "Cria Code Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.Cria CodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.Cria CodeZen.visit.prefix": "访问 ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Cria Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Cria Code 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 Cria Code.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Cria Code 服务器。",
  ...
  "wsl.onboarding.checkingCria Code": "正在检查 Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "正在检查 {{distro}} 中的 Cria Code...",
  "wsl.onboarding.updatingCria Code": "正在更新 Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "正在更新 {{distro}} 中的 Cria Code...",
  "wsl.onboarding.updateCria CodeIn": "更新 {{distro}} 中的 Cria Code。",
  "wsl.onboarding.updateCria Code": "更新 Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "{{distro}} 中的 Cria Code 已就绪。",
  "wsl.onboarding.Cria CodeReady": "Cria Code 已就绪。",
  "wsl.onboarding.installCria CodeIn": "在 {{distro}} 中安装 Cria Code。",
  "wsl.onboarding.installCria Code": "安装 Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "未安装 Cria Code",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Cria Code 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Cria Code 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Cria Code。",
  ...
  "toast.update.description": "Cria Code 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Cria Code 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (Cria Code.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Cria Code 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Cria Code 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Cria Code 服务器。",
  ...
  "settings.general.row.language.description": "更改 Cria Code 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Cria Code 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Cria Code 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Cria Code 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Cria Code 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Cria Code。",
