...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 Cria Code Zen 或 API 密钥连接",
  ...
  "provider.connect.opencodeZen.line1": "Cria Code Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Cria Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Cria Code...",
  "wsl.onboarding.updatingOpencode": "正在更新 Cria Code...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Cria Code...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Cria Code。",
  "wsl.onboarding.updateOpencode": "更新 Cria Code",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Cria Code 已就绪。",
  "wsl.onboarding.opencodeReady": "Cria Code 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Cria Code。",
  "wsl.onboarding.installOpencode": "安装 Cria Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Cria Code",
