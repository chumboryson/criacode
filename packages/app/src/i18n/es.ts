export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.Cria Code.tagline": "Modelos optimizados y fiables",
  "dialog.provider.Cria CodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.Cria CodeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.Cria CodeZen.visit.prefix": "Visita ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Cria Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados en Cria Code.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Cria Code se conecta esta app.",
  ...
  "wsl.onboarding.checkingCria Code": "Comprobando Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Comprobando Cria Code en {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Actualizando Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Actualizando Cria Code en {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Actualiza Cria Code en {{distro}}.",
  "wsl.onboarding.updateCria Code": "Actualizar Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code está listo en {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code está listo.",
  "wsl.onboarding.installCria CodeIn": "Instala Cria Code en {{distro}}.",
  "wsl.onboarding.installCria Code": "Instalar Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Cria Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Cria Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Cria Code.",
  ...
  "toast.update.description": "Una nueva versión de Cria Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Cria Code",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (Cria Code.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Cria Code no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Cria Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Cria Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Cria Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Cria Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Cria Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Cria Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Cria Code.",
