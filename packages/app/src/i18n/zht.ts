...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1": "Cria Code Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Cria Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Cria Code...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Cria Code 已就緒。",
  "wsl.onboarding.opencodeReady": "Cria Code 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Cria Code。",
  "wsl.onboarding.installOpencode": "安裝 Cria Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Cria Code",
