...
export const dict = {
  ...
  "dialog.provider.Cria Code.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.Cria Code.tagline": "可靠的優化模型",
  "dialog.provider.Cria CodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Cria Code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Cria Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.Cria CodeZen.line1": "Cria Code Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.Cria CodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.Cria CodeZen.visit.prefix": "造訪 ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Cria Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Cria Code 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 Cria Code.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Cria Code 伺服器。",
  ...
  "wsl.onboarding.checkingCria Code": "正在檢查 Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "正在檢查 {{distro}} 中的 Cria Code...",
  ...
  "wsl.onboarding.Cria CodeReadyIn": "{{distro}} 中的 Cria Code 已就緒。",
  "wsl.onboarding.Cria CodeReady": "Cria Code 已就緒。",
  "wsl.onboarding.installCria CodeIn": "在 {{distro}} 中安裝 Cria Code。",
  "wsl.onboarding.installCria Code": "安裝 Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "未安裝 Cria Code",
  ...
  "wsl.onboarding.wslUnavailable.description": "Cria Code 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Cria Code。",
  ...
  "toast.update.description": "Cria Code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Cria Code 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (Cria Code.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Cria Code 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Cria Code 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Cria Code 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Cria Code 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Cria Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Cria Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Cria Code 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Cria Code 啟動時自動檢查更新",
