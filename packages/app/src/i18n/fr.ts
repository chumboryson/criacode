export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Cria Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Cria Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Cria Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Cria Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Cria Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Cria Code",
  "wsl.onboarding.opencodeReadyIn": "Cria Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cria Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Cria Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Cria Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cria Code non installé",
