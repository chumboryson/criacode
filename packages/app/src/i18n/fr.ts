export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.Cria Code.tagline": "Modèles optimisés et fiables",
  "dialog.provider.Cria CodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Visitez ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Cria Code.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans Cria Code.json",
  ...
  "dialog.server.description": "Changez le serveur Cria Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingCria Code": "Vérification d'Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Vérification d'Cria Code dans {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Mise à jour d'Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Mise à jour d'Cria Code dans {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Mettez à jour Cria Code dans {{distro}}.",
  "wsl.onboarding.updateCria Code": "Mettre à jour Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code est prêt dans {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code est prêt.",
  "wsl.onboarding.installCria CodeIn": "Installez Cria Code dans {{distro}}.",
  "wsl.onboarding.installCria Code": "Installer Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Cria Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Cria Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Cria Code.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Cria Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Cria Code",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (Cria Code.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Cria Code ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Cria Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Cria Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Cria Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Cria Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Cria Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Cria Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Cria Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Cria Code.",
