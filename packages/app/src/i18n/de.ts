...
export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.Cria Code.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.Cria CodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cria Code zu nutzen.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.Cria CodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.Cria CodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Cria Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cria Code zu nutzen.",
  ...
  "dialog.plugins.empty": "in Cria Code.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Cria Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.Cria Code": "Cria Code",
  ...
  "wsl.onboarding.checkingCria Code": "Cria Code wird geprüft...",
  "wsl.onboarding.checkingCria CodeIn": "Cria Code in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingCria Code": "Cria Code wird aktualisiert...",
  "wsl.onboarding.updatingCria CodeIn": "Cria Code in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateCria CodeIn": "Aktualisieren Sie Cria Code in {{distro}}.",
  "wsl.onboarding.updateCria Code": "Cria Code aktualisieren",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code ist in {{distro}} bereit.",
  "wsl.onboarding.Cria CodeReady": "Cria Code ist bereit.",
  "wsl.onboarding.installCria CodeIn": "Installieren Sie Cria Code in {{distro}}.",
  "wsl.onboarding.installCria Code": "Cria Code installieren",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Cria Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Cria Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Cria Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von Cria Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Cria Code-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (Cria Code.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Cria Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Cria Code Desktop",
  ...
  "settings.desktop.wsl.description": "Cria Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Cria Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Cria Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Cria Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Cria Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Cria Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Cria Code.",
