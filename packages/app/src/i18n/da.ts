export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.Cria Code.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.Cria CodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.Cria CodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.Cria CodeZen.visit.prefix": "Besøg ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Cria Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i Cria Code.json",
  ...
  "dialog.server.description": "Skift hvilken Cria Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingCria Code": "Tjekker Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Tjekker Cria Code i {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Opdaterer Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Opdaterer Cria Code i {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Opdater Cria Code i {{distro}}.",
  "wsl.onboarding.updateCria Code": "Opdater Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Cria Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Cria Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Cria Code igen.",
  ...
  "toast.update.description": "En ny version af Cria Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Cria Code-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (Cria Code.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Cria Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Cria Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Cria Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Cria Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Cria Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Cria Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Cria Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Cria Code.",
