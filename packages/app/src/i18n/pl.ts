export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.Cria Code.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.Cria CodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Cria Code.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w Cria Code.json",
  ...
  "dialog.server.description": "Przełącz serwer Cria Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingCria Code": "Sprawdzanie Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Sprawdzanie Cria Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Aktualizowanie Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Aktualizowanie Cria Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Zaktualizuj Cria Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateCria Code": "Zaktualizuj Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code jest gotowy.",
  "wsl.onboarding.installCria CodeIn": "Zainstaluj Cria Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installCria Code": "Zainstaluj Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Cria Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Cria Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Cria Code.",
  ...
  "toast.update.description": "Nowa wersja Cria Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cria Code",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (Cria Code.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Cria Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Cria Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Cria Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cria Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Cria Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Cria Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cria Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Cria Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Cria Code.",
