export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.Cria Code.tagline": "Надежные оптимизированные модели",
  "dialog.provider.Cria CodeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Посетите ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Cria Code.",
  ...
  "dialog.plugins.empty": "Плагины настроены в Cria Code.json",
  ...
  "dialog.server.description": "Переключите сервер Cria Code к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingCria Code": "Проверка Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Проверка Cria Code в {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Обновление Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Обновление Cria Code в {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Обновите Cria Code в {{distro}}.",
  "wsl.onboarding.updateCria Code": "Обновить Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code в {{distro}} готов к работе.",
  "wsl.onboarding.Cria CodeReady": "Cria Code готов к работе.",
  "wsl.onboarding.installCria CodeIn": "Установите Cria Code в {{distro}}.",
  "wsl.onboarding.installCria Code": "Установить Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Cria Code требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Cria Code не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Cria Code.",
  ...
  "toast.update.description": "Новая версия Cria Code ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Cria Code",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (Cria Code.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Cria Code пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Cria Code внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Cria Code",
  ...
  "settings.general.row.appearance.description": "Настройте как Cria Code выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Cria Code системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Cria Code.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Cria Code",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Cria Code.",
