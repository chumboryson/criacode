export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.Cria Code.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.Cria CodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Cria Code.",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.Cria CodeZen.visit.prefix": "Visite ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Cria Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados em Cria Code.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Cria Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingCria Code": "Verificando o Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Verificando o Cria Code em {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Atualizando o Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Atualizando o Cria Code em {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Atualize o Cria Code em {{distro}}.",
  "wsl.onboarding.updateCria Code": "Atualizar o Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "O Cria Code está pronto em {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "O Cria Code está pronto.",
  "wsl.onboarding.installCria CodeIn": "Instale o Cria Code em {{distro}}.",
  "wsl.onboarding.installCria Code": "Instalar o Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Cria Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Cria Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Cria Code novamente.",
  ...
  "toast.update.description": "Uma nova versão do Cria Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Cria Code",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (Cria Code.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Cria Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Cria Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Cria Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Cria Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Cria Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Cria Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Cria Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Cria Code.",
