export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.Cria Code.tagline": "Reliable optimized models",
  "dialog.provider.Cria CodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Cria Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cria Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.Cria CodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.Cria CodeZen.visit.prefix": "Visit ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Cria Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Cria Code.",
  ...
  "dialog.plugins.empty": "Plugins configured in Cria Code.json",
  ...
  "dialog.server.description": "Switch which Cria Code server this app connects to.",
  ...
  "wsl.onboarding.checkingCria Code": "Checking Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "Checking Cria Code in {{distro}}...",
  "wsl.onboarding.updatingCria Code": "Updating Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "Updating Cria Code in {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "Update Cria Code in {{distro}}.",
  "wsl.onboarding.updateCria Code": "Update Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code is ready in {{distro}}.",
  "wsl.onboarding.Cria CodeReady": "Cria Code is ready.",
  "wsl.onboarding.installCria CodeIn": "install Cria Code in {{distro}}.",
  "wsl.onboarding.installCria Code": "install Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Cria Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Cria Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Cria Code.",
  ...
  "toast.update.description": "A new version of Cria Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Cria Code team",
  ...
  "error.chain.checkConfig": "Check your config (Cria Code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cria Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Cria Code includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Cria Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Cria Code",
  ...
  "settings.general.row.appearance.description": "Customise how Cria Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Cria Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cria Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Cria Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Cria Code.",
