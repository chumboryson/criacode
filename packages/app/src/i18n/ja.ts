export const dict = {
  ...
  "wsl.onboarding.checkingOpencode": "Cria Codeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCria Codeを確認中...",
  "wsl.onboarding.updatingOpencode": "Cria Codeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCria Codeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCria Codeを更新してください。",
  "wsl.onboarding.updateOpencode": "Cria Codeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCria Codeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Cria Codeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCria Codeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Cria Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cria Codeがインストールされていません",
