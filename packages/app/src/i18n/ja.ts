export const dict = {
  ...
  "dialog.provider.Cria Code.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.Cria Code.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.Cria CodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Cria Codeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Cria Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.Cria CodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.Cria CodeZen.visit.prefix": " ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCria Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Cria Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "Cria Code.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCria Codeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingCria Code": "Cria Codeを確認中...",
  "wsl.onboarding.checkingCria CodeIn": "{{distro}}内のCria Codeを確認中...",
  "wsl.onboarding.updatingCria Code": "Cria Codeを更新中...",
  "wsl.onboarding.updatingCria CodeIn": "{{distro}}内のCria Codeを更新中...",
  "wsl.onboarding.updateCria CodeIn": "{{distro}}内のCria Codeを更新してください。",
  "wsl.onboarding.updateCria Code": "Cria Codeを更新",
  "wsl.onboarding.Cria CodeReadyIn": "{{distro}}内のCria Codeの準備ができました。",
  "wsl.onboarding.Cria CodeReady": "Cria Codeの準備ができました。",
  "wsl.onboarding.installCria CodeIn": "{{distro}}にCria Codeをインストールしてください。",
  "wsl.onboarding.installCria Code": "Cria Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "Cria Codeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cria CodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Cria Codeをもう一度開いてください。",
  ...
  "toast.update.description": "Cria Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCria Codeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (Cria Code.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Cria CodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Cria Codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCria Codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Cria Codeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCria Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Cria Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Cria Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Cria Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Cria Code は最新バージョンです。",
