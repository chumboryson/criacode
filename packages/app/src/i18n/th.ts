export const dict = {
  ...
  "dialog.provider.Cria Code.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.Cria Code.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.Cria CodeGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Cria Code",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cria Code",
  ...
  "provider.connect.Cria CodeZen.line1":
    "Cria Code Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.Cria CodeZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.Cria CodeZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.Cria CodeZen.visit.link": "Cria Code.ai/zen",
  "provider.connect.Cria CodeZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cria Code",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Cria Code",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน Cria Code.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Cria Code ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingCria Code": "กำลังตรวจสอบ Cria Code...",
  "wsl.onboarding.checkingCria CodeIn": "กำลังตรวจสอบ Cria Code ใน {{distro}}...",
  "wsl.onboarding.updatingCria Code": "กำลังอัปเดต Cria Code...",
  "wsl.onboarding.updatingCria CodeIn": "กำลังอัปเดต Cria Code ใน {{distro}}...",
  "wsl.onboarding.updateCria CodeIn": "อัปเดต Cria Code ใน {{distro}}.",
  "wsl.onboarding.updateCria Code": "อัปเดต Cria Code",
  "wsl.onboarding.Cria CodeReadyIn": "Cria Code พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.Cria CodeReady": "Cria Code พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installCria CodeIn": "ติดตั้ง Cria Code ใน {{distro}}.",
  "wsl.onboarding.installCria Code": "ติดตั้ง Cria Code",
  ...
  "wsl.onboarding.distroStatus.Cria CodeMissing": "ยังไม่ได้ติดตั้ง Cria Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Cria Code จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Cria Code ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Cria Code อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Cria Code ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Cria Code",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (Cria Code.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Cria Code ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Cria Code รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Cria Code ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Cria Code",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Cria Code มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Cria Code ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Cria Code มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Cria Code เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Cria Code เวอร์ชันล่าสุด",
